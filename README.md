...
For a full cookbook (per-OS ffmpeg input strings, snapshot capture, live preview, ASR / VAD wiring), see [📋 EXAMPLES.md](https://github.com/warith-harchaoui/capture-helper/blob/main/EXAMPLES.md).
...
see [📋 GUI.md](https://github.com/warith-harchaoui/capture-helper/blob/main/GUI.md). For a competitive comparison against
OpenCV / PyAV / sounddevice / OBS / FFmpeg CLI / GStreamer, see
[📋 LANDSCAPE.md](https://github.com/warith-harchaoui/capture-helper/blob/main/LANDSCAPE.md).
